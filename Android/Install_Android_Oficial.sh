...
# Welcome message
echo "Welcome to the automatic installer for the Android 5.6.3 by DRL Edition."
...
curl -L -o $DRL_FILE "https://github.com/DRLEdition19/DRLEdition_Interface/releases/download/files/Android_5.6.3.DRL"
...
echo "Android 5.6.3 by DRL Edition"
