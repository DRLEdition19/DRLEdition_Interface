...
wget -O /tmp/Install_Android_Oficial.sh https://github.com/DRLEdition19/DRLEdition_Interface/raw/refs/heads/main/Android/Install_Android_Oficial.sh
echo "Download concluído com sucesso."

# Configura as permissões
echo "Configurando permissões (chmod 777)..."
chmod 777 /tmp/Install_Android_Oficial.sh
...
rm -r -f /tmp/Install_Android_Oficial.sh
