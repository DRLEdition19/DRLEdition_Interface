...
* ***Atualização - 07.06.2025***
    ...
    * **Implentando uma função mais robusta para rodar jogos a partir do gerenciador de arquivos. (Agora a função se chama "Run Game", e funciona para diversos emuladores, desde que os jogos estejam dentro das pastas de seus respectivos emuladores.)*
