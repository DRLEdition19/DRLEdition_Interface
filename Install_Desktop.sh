...
# Welcome message
echo "Welcome to the automatic installer for the Desktop_for_Batocera 8.6.1 by DRL Edition."
...
curl -L -o $DRL_FILE "https://github.com/DRLEdition19/DRLEdition_Interface/releases/download/files/Desktop_for_batocera_8.6.1.DRL"
...
echo "Desktop_for_Batocera 8.6.1 by DRL Edition"
