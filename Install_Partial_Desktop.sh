...
# Welcome message
echo "Welcome to the automatic installer for the Desktop_Update 8.7.1 by DRL Edition."
...
curl -L -o $DRL_FILE "https://github.com/DRLEdition19/DRLEdition_Interface/releases/download/files/Desktop_Update_8.7.1.DRL"
...
echo "Desktop_Update 8.7.1 by DRL Edition"
